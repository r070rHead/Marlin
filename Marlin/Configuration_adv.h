...
#define SENSORLESS_BACKOFF_MM  { 2, 2, 0 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing // KBY - Default: Disabled

#define HOMING_BUMP_MM      { 0, 0, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump // KBY - Default: { 5, 5, 2 }
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 2, 2, 2 }  // (linear=mm, rotational=°) Backoff from endstops after homing // KBY - Default: Disabled
//#define XY_COUNTERPART_BACKOFF_MM 0         // (mm) Backoff X after homing Y, and vice-versa

#define QUICK_HOME                            // If G28 contains XY do a diagonal move first // KBY - Default: Disabled
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 300 // KBY - Default: Disabled, 500
   ...
   */
  #define BLTOUCH_HS_MODE true // KBY - Default: Disabled
 ...
 */
#define Z_STEPPER_AUTO_ALIGN // KBY - Default: Disabled
...
//
#define ASSISTED_TRAMMING // KBY - Default: Disabled
#if ENABLED(ASSISTED_TRAMMING)

  // Define positions for probe points.
  #define TRAMMING_POINT_XY { {  30, 30 }, { 195,  30 }, { 195, 202 }, { 30, 202 } } // KBY - Default: { {  20, 20 }, { 180,  20 }, { 180, 180 }, { 20, 180 } }
  ...
  #define REPORT_TRAMMING_MM          // Report Z deviation (mm) for each point relative to the first // KBY - Default: Disabled

  #define ASSISTED_TRAMMING_WIZARD    // Add a Tramming Wizard to the LCD menu // KBY - Default: Disabled
 ...
 */
#define INPUT_SHAPING_X // KBY - Default: Disabled
#define INPUT_SHAPING_Y // KBY - Default: Disabled
#if EITHER(INPUT_SHAPING_X, INPUT_SHAPING_Y)
  #if ENABLED(INPUT_SHAPING_X)
    #define SHAPING_FREQ_X  35.15          // (Hz) The default dominant resonant frequency on the X axis. // KBY - Default: 40
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  38.91          // (Hz) The default dominant resonant frequency on the Y axis. // KBY - Default: 40
    #define SHAPING_ZETA_Y  0.15f       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  //#define SHAPING_MIN_FREQ  20        // By default the minimum of the shaping frequencies. Override to affect SRAM usage.
  //#define SHAPING_MAX_STEPRATE 10000  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
  #define SHAPING_MENU // KBY - Default: Disabled               // Add a menu to the LCD to set shaping parameters.
#endif
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.201 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.201        // (mm) Compression length applying to all extruders
  #endif
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       800        // (mA) RMS current. Multiply by 1.414 for peak current.  // KBY - Default: 800
    ...
    #define Y_CURRENT       800 // KBY - Default: 800
    ...
    #define Z_CURRENT       800 // KBY - Default: 800
    ...
    #define Z2_CURRENT      800 // KBY - Default: 800
    ...
    #define E0_CURRENT      800 // KBY - Default: 900
  ...
  #define X_HYBRID_THRESHOLD     100  // [mm/s] // KBY - Default: 100
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     100  // KBY - Default: 100
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only // KBY - Default: Disabled
