...
#define STRING_CONFIG_H_AUTHOR "(The YeatesClan, Ender3)" // Who made the changes.
 ...
 */
#define X_DRIVER_TYPE  TMC2209 // KBY - Default: A4988
#define Y_DRIVER_TYPE  TMC2209 // KBY - Default: A4988
#define Z_DRIVER_TYPE  TMC2209 // KBY - Default: A4988
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2209 // KBY - Default: A4988
...
#define E0_DRIVER_TYPE TMC2209 // KBY - Default: A4988
...
#define EXTRUDE_MAXLENGTH 400 // KBY
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 426.75 }  // KBY - Ender 3 Default: { 80, 80, 400, 93 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 1000 } // KBY - Ender 3 Default: { 500, 500, 100, 1000 }
...
//#define CLASSIC_JERK
  ...
  #define DEFAULT_ZJERK  0.4 // KBY - Ender 3 Default: 0.4, Marlin Default: 0.3
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.08 // (mm) Distance from real junction edge (WAS SET TO 0.013)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -55, -18.5, -1.738 }    // KBY - Default: -1.33
...
#define XY_PROBE_FEEDRATE (150*60) // KBY - Default: (50*60), Previous: (133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (10*60) // KBY - Default: (4*60)
 ...
 */
//#define MULTIPLE_PROBING 3 // KBY - Default: Disabled, 2
...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // Z Clearance between probe points // KBY - Default: 5
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 7 // KBY - Default: 3
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 15
  //#define Z_SAFE_HOMING_Y_POINT Y_CENTER  // Y point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 15
#endif

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (10*60) } // KBY - Default: { (60*60), (60*60), (15*60) }
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 2), 20 }
